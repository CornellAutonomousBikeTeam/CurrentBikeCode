...
void setup() 
{
  ...
  //byte gpsmsg[] = {0xB5,0x62,0x06,0x08,0x06,0x00,0xC8,0x00};
  //byte gpsmsg2[] = {0x01,0x00,0x01,0x00,0xDE,0x6A};

  //sending the hex message to the gps with the sendUBX function
  //sendUBX(gpsmsg,sizeof(gpsmsg));
  //sendUBX(gpsmsg2,sizeof(gpsmsg2));
