...
int_16_t value = //16 bit value - any integer is 16_t
...
void loop() {
  ...
  //why while loop as opposed to for loop
...
*/
  ...
  if (result_loop == 0x01) {
    ...
    //comment timing section of the code
    startMillis = micros();
...
//conversions from float to int and int to float
